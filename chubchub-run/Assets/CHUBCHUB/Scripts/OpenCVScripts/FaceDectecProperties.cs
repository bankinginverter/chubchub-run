namespace OpenCvSharp.FaceLocationOnly
{
    ...
    public class FaceDectecProperties : WebCamera
    {
        public TextAsset faces;
        public TextAsset eyes;
        public TextAsset shapes;

        private FaceDetector<WebCamTexture> processor;
        ...
        protected override void Awake()
        {
            ...
            processor = new FaceDetector<WebCamTexture>();
            ...
            //processorFaceLocation.Initialize(faces.text, eyes.text, shapes.bytes);
        }
